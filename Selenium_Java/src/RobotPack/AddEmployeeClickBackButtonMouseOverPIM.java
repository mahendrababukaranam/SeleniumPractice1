...
public class AddEmployeeClickBackButtonMouseOverPIM {
	...
	public static void main(String[] args) throws InterruptedException, AWTException {
		...
		driver.findElement(By.name("txtEmployeeId")).sendKeys("1220");
		driver.findElement(By.name("txtEmpLastName")).sendKeys("M");
		driver.findElement(By.name("txtEmpMiddleName")).sendKeys("Vennela");
		driver.findElement(By.name("txtEmpFirstName")).sendKeys("Siri");
		driver.findElement(By.name("txtEmpNickName")).sendKeys("Siri");
